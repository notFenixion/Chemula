...
public class Bromine extends Atom{
    ...
    public Bromine(double xPos, double yPos) {
        this.setxPos(xPos);
        this.setyPos(yPos);
        this.createNewAtom();
        this.setMaxBonds(1);
        ...
        this.setAtomText("Br");
        this.setAtomColor(Color.web("#875053"));
        this.setAtomType("Bromine");
    ...
    public void drawAtomDisplayed() {
        ...
        circle.setRadius(20);
        circle.setFill(Color.web("875053"));
        circle.setStroke(Color.BLACK);
        //Draw text inside circle
        Text atomText = new Text("Br");
