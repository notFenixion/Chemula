...
public class Fluorine extends Atom{
    ...
    public Fluorine(double xPos, double yPos) {
        this.setxPos(xPos);
        this.setyPos(yPos);
        this.createNewAtom();
        this.setMaxBonds(1);
        ...
        this.setAtomText("F");
        this.setAtomColor(Color.web("#885FBF"));
        this.setAtomType("Fluorine");
    ...
    public void drawAtomDisplayed() {
        ...
        circle.setRadius(20);
        circle.setFill(Color.web("885FBF"));
        circle.setStroke(Color.BLACK);
        //Draw text inside circle
        Text atomText = new Text("F");
