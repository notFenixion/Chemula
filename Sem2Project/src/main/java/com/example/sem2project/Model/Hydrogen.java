...
public class Hydrogen extends Atom {
    ...
    public Hydrogen(double xPos, double yPos) {
        this.setxPos(xPos);
        this.setyPos(yPos);
        this.createNewAtom();
        this.setMaxBonds(1);
        ...
        this.setAtomText("H");
        this.setAtomColor(Color.web("#0DAB76"));
        this.setAtomType("Hydrogen");
    ...
    public void drawAtomDisplayed() {
        ...
        circle.setRadius(20);
        circle.setFill(Color.web("0DAB76"));
        circle.setStroke(Color.BLACK);
        //Draw text inside circle
        Text atomText = new Text("H");
